...
public class FootballTeamTest {
    ...
    public void constructorShouldSetGamesWon(final int nbOfGamesWon) {
        final FootballTeam team = new FootballTeam(nbOfGamesWon);
    ...
    public void constructorShouldThrowExceptionForIllegalGamesNb(final int illegalNbOfGames) {
    ...
    public void teamWithMoreMatchesWonShouldBeGreater() {
        final FootballTeam team_2 = new FootballTeam(2);
        final FootballTeam team_3 = new FootballTeam(3);
